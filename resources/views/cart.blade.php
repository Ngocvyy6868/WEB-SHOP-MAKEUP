...
<body>
    ...
    <div class="cart-container">
        <button class="back-btn" style="float:left;"
            onclick="window.location.href='{{ url('/danh-sach-da-dat-hang') }}';">Danh sách đơn hàng</button>
        <button class="back-btn" onclick="window.location.href='{{ url('/hien-thi-san-pham')}}';">Trở về</button>
        ...
        <form action="{{ route('cart.update') }}" method="POST">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $details['name'] }}</td>
                        <td>{{ number_format($price, 0, ',', '.') }} ,000 VNĐ</td>
                        <td>
            ...
            <div class="cart-summary">
                <h5>Tổng cộng: {{ number_format($total, 0, ',', ',') }} ,000 VNĐ</h5>
                <h5><strong>Tổng số lượng: </strong>{{ $totalQuantity }}</h5> <!-- Hiển thị tổng số lượng -->
            </div>
