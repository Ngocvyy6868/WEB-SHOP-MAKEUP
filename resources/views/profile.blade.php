        ...
        <div class="card profile-card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="text-center mb-4">
                    @if($profile->img)
                    <img src="{{ asset($profile->img) }}" alt="Profile Image" class="profile-img rounded-circle">
                    @else
                ...
                <div class="profile-info mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-8">{{ $profile->fullname }}</div>
                    </div>
                    <div class="row">
                ...
                <!-- Nút chỉnh sửa hồ sơ -->
                <div class="text-center">
                    <a href="{{ route('change-password.form') }}" class="btn btn-primary">Đổi Mật Khẩu</a>
